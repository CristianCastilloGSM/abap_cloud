CLASS zcl_metodos_012 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_metodos_012 IMPLEMENTATION.
...
**********************************************************************
   ...
   data: c_carrier_id1 type /dmo/carrier_id,
                c_connection_id1 TYPE /dmo/connection_id.
...
*            i_connection_id = c_connection_id
            i_carrier_id    = c_carrier_id1
            i_connection_id = c_connection_id1
        ).
